...
i_milk:Ingredient = Ingredient("milk", 50)
i_froth:Ingredient = Ingredient("froth", 50)

r_espresso:Recipe = Recipe("Espresso", {i_espresso: 1})
r_macchiato:Recipe = Recipe("Espresso Macchiato", {i_espresso: 1, i_froth: 1})
r_cappuccino:Recipe = Recipe("Cappuccino", {i_espresso: 1, i_milk: 1, i_froth: 2})
r_latte:Recipe = Recipe("Café Latte", {i_milk: 2, i_froth: 1, i_espresso: 1})
